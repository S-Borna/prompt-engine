...
import { Sparkles, Mail, Lock, User, Eye, EyeOff, ArrowRight, Github, AlertCircle, Loader2, Check } from 'lucide-react';
import { signIn } from 'next-auth/react';
import toast from 'react-hot-toast';

// ═══════════════════════════════════════════════════════════════════════════
// PRAXIS Signup - Unified dark theme matching landing page
// Clean, confident, premium onboarding experience
// ═══════════════════════════════════════════════════════════════════════════
        ...
        <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0f', color: 'white' }}>
            ...
            <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
                ...
                <div style={{
                    ...
                    backgroundColor: 'rgb(236,72,153)', opacity: 0.08,
            ...
            <main style={{
                ...
                <div style={{
                    ...
                    gap: '48px', maxWidth: '900px', width: '100%', alignItems: 'center'
                }}>
                    {/* Left side - Value prop (hidden on mobile) */}
                    <div className="hidden-mobile" style={{ paddingRight: '24px' }}>
                        <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '16px', lineHeight: 1.2 }}>
                            Start crafting better prompts today
                        </h1>
                        <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '16px', marginBottom: '32px', lineHeight: 1.6 }}>
                            Join creators and developers using AI more effectively with structured prompt engineering.
                        </p>
                            ...
                            {features.map((feature) => (
                                <div key={feature} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                    <div style={{
                                        ...
                                        <Check style={{ width: '14px', height: '14px', color: '#a78bfa' }} />
                                    </div>
                    ...
                    <div style={{
                        ...
                        {error && (
                            <div style={{
                                ...
                                padding: '12px 14px', backgroundColor: 'rgba(239,68,68,0.1)',
                        ...
                        <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
                            <button
                                ...
                                style={{
                                    ...
                                    padding: '11px 14px', backgroundColor: 'rgba(255,255,255,0.06)',
                                ...
                                {password && (
                                    <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                        ...
                                        <span style={{
                                            ...
                                            color: passwordStrength === 'weak' ? '#f87171' : passwordStrength === 'medium' ? '#fbbf24' : '#4ade80'
                                        }}>
                        ...
                        {/* Terms */}
                        <p style={{ marginTop: '16px', textAlign: 'center', fontSize: '11px', color: 'rgba(255,255,255,0.4)', lineHeight: 1.5 }}>
